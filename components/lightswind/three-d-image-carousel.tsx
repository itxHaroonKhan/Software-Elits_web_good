...
@media screen and (max-width: 575px) {
    .cascade-slider_container { height: 45vh; }
    .cascade-slider_slides img { max-width: 140px; border-radius: 25px; }
    .cascade-slider_item.next { transform: translateY(-50%) translateX(-100%) scale(0.5); }
    .cascade-slider_item.prev { transform: translateY(-50%) translateX(0%) scale(0.5); }
    .cascade-slider_arrow-left { left: 2px; }
    .cascade-slider_arrow-right { right: 2px; }
}
...
@media screen and (min-width: 576px) {
    .cascade-slider_container { height: 70vh; }
...
export const ThreeDImageCarousel: React.FC<ThreeDImageCarouselProps> = ({
    ...
    const handleMouseEnter = () => { if (autoplay && pauseOnHover) stopAutoplay(); };
    ...
    const onMouseUp = (e: React.MouseEvent) => { handleEnd(e.clientX); startAutoplay(); };
    const onTouchStart = (e: React.TouchEvent) => handleStart(e.touches[0].clientX);
    const onTouchEnd = (e: React.TouchEvent) => { handleEnd(e.changedTouches[0].clientX); startAutoplay(); };
